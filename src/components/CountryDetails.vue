...
<template>
    <div class="col-7" v-if="cc">
        <img :src="`https://flagpedia.net/data/flags/w580/${cc.alpha2Code.toLowerCase()}.webp`" alt="country flag"
            style="width: 300px" />
                ...
                <tr>
                    ...
                    <td>
                        <ul v-for="(borderCountry, index) in cc.borders" :key="index">
                            <li><router-link class="" :to="`/list/${borderCountry}`">{{ borderCountry }}</router-link>
                            </li>
                        </ul>
                    </td>
                </tr>
